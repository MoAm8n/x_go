...
const HowItWorks: React.FC = () => {
  ...
  const steps = [
    {
      number: "01",
      title: t("Discover Your Perfect Car"),
      description: t("Lorem ipsum dolor sit amet consectetur. Au ele malesuada pretium sed porta. Augue massa ipsum odio urna vel nisl."),
    },
    {
      number: "02",
      title: t("Secure Your Rental Booking"),
      description: "",
    },
    {
      number: "03",
      title: t("Complete Your Booking Payment"),
      description: "",
    },
    {
      number: "04",
      title: t("Your Booking is Confirmed"),
      description: "",
    },
  ];
  ...
  return (
    <section className="w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-10 p-4 sm:p-6 md:p-8 mt-8 mb-12 items-center">
      <div className="w-full lg:w-1/2 max-w-lg flex-1 mx-auto">
        <h4 className="text-[#E6911E] mb-2 font-semibold text-xl md:text-4xl">{t("How It Works")}</h4>
        <h2 className="mb-8 font-semibold text-xl md:text-4xl">
          {t("Step by step to rent a car on our platform")}
        </h2>
      ...
      <div className="w-full lg:w-1/2 max-w-xl flex-1 mx-auto flex flex-col">
        <div className="mb-4 mt-6 w-full">
          <h4 className="font-bold text-lg md:text-2xl mb-4">{t("Car Type")}</h4>
        ...
        <div className="flex gap-4 max-sm:gap-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
          {cars.map((car) => (
            ...
            >
              ...
              />
              <div className="px-2">
                <p className="font-medium text-sm md:text-lg">{t(`brand.${car.name}`)}</p>
