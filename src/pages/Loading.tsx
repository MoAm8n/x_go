...
const Home = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen w-full bg-gray-50 bg-white">
      ...
      <section id="vehicles">
        <div className="container mx-auto px-6 md:px-12 py-8">
          <div className="text-center mb-8">
            <h1 className="text-[#E6911E] font-semibold text-xl md:text-4xl pb-2 md:pb-4">
              Collection
            </h1>
      ...
      <section id="about">
        <div className="container mx-auto px-14 py-8">
          <div className=" flex flex-col mb-8">
            <h4 className="text-[#E6911E] mb-2 mt-2 tracking-wide text-center font-semibold text-xl md:text-4xl">
              WHY CHOOSE US
            </h4>
